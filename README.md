...
- 保留最近 5 个已完成任务，点击即可回到对应 Codex 会话
- 任务完成时发送本机系统通知
...
| macOS 13+ Apple Silicon          | 可下载 | [v1.2.0](https://github.com/EricZzzzz221b/token-usage/releases/tag/v1.2.0) · [DMG](https://github.com/EricZzzzz221b/token-usage/releases/download/v1.2.0/TokenUsage_1.2.0_arm64.dmg) · [SHA-256](https://github.com/EricZzzzz221b/token-usage/releases/download/v1.2.0/SHA256SUMS-1.2.0.txt)                                                                                                                                                                     |
...
下载 [DMG](https://github.com/EricZzzzz221b/token-usage/releases/download/v1.2.0/TokenUsage_1.2.0_arm64.dmg) 后，将 `Token用量.app` 拖入 `Applications`。当前包采用 ad-hoc 签名；首次启动请在 Finder 中右键应用并选择“打开”。v1.2.0 新增账号模式识别、Credits 与重置机会、Codex 实时任务状态、完成通知和会话跳转，并通过增量读取会话事件降低后台扫描开销。
